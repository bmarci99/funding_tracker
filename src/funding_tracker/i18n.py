...
STRINGS = {
    "en": {
        ...
        "stat_ai": "🤖 {n} AI picks",
        "sec_found_rank": "🏛 Foundations & national funders — AI ranking",
        "sec_found_rank_count": "top {n} of {total} calls read by the analyst · every call is scored, whatever the result",
        "sec_found_all": "🏛 All foundation & national calls — ranked",
        "col_ai": "AI", "col_fit": "Fit", "ai_verdict_short": "AI verdict",
    ...
    "hu": {
        ...
        "sec_found_rank": "🏛 Alapítványok és nemzeti támogatók — AI-rangsor",
        "sec_found_rank_count": "a(z) {total} elemzett felhívásból az első {n} · minden felhívás pontozva, eredménytől függetlenül",
        "sec_found_all": "🏛 Minden alapítványi és nemzeti felhívás — rangsorolva",
        "col_ai": "AI", "col_fit": "Illeszkedés", "ai_verdict_short": "AI-vélemény",
